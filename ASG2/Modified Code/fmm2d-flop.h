...
/* Constants for timing measurement *******************************************/
#define FSQRT 10.0
#define FLOG 10.0
#define FATAN 10.0
...
double ffmm;             /* Floating-clock time for FMM */
double tdirect;          /* Wall-clock time for direct calculation */
double fdirect;          /* Floating-clock time for direct calculation */
